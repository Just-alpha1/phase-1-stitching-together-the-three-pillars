...
// STEP 1: DOM Manipulation - Find all heart elements
...
function likeCallback(e) {
  ...
  mimicServerCall()
    .then(function(serverMessage){
      // STEP 2: Server Communication & DOM Updates
...
// STEP 3: Event Listening (Pillar 2)
// In order for the call to the server and the update of the screen to
